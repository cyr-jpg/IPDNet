...
if __name__ == '__main__':
    # 加载模型
    model = YOLO(r'/home/nvidia/chunguole/runs/xiao/ours431/weights/best.pt')
    metrics=model.val(
        val=False,  # (bool) 在训练期间进行验证/测试
        data=r'/home/nvidia/chunguole/cyr/ultralytics-main/ai/data.yaml',
